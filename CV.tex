...
\item[37\hspace{4pt}] \textbf{qubit-ADAPT-VQE: An adaptive algorithm for constructing hardware-efficient ansatze on a quantum processor} \\
...
\begin{center}
	\vspace{5pt}
	\Vhrulefill{} \textbf{In Press} {} \Vhrulefill
	\vspace{4pt}
\end{center}
...
\begin{lonelist}
	  \setlength\itemsep{.75pt}
\item
Title: ``CAREER: Many-body expansions for strongly correlated systems'' \\
Role on project: PI \\
...
\item
Title: ``Ab initio design of quantum molecular magnets for information applications'' \\
Role on project: co-PI (with three co-PIs) \\
...
\item
Title: ``Simulating strongly correlated molecules with a superconducting processor''\\
Role on project: PI (with three co-PIs)\\
Source of Support: Department of Energy \\
Total award amount: \$1,875,000 (Mayhall's budget \$308,871)  \\
Total award period: Sept. 15, 2018 - Sep. 14, 2021 \\

\item
Title: ``RAISE: TAQS: Fast multiqubit control of high-coherence transmons for efficient quantum chemistry simulations'' \\
Role on project: co-PI (with three co-PIs)\\
Source of Support: National Science Foundation \\
...
\item
Title: ``QLCI-CG: Center for Interdisciplinary Research in Quantum Information Theory and Simulation'' \\
Role on project: co-PI (with three co-PIs)\\
Source of Support: National Science Foundation \\
Total award amount: \$118,125\\
