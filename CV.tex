...
Alfred P. Sloan Research Fellow & VT & 2021
\end{tabular}
\newline
\begin{tabular}{p{240pt} p{80pt} l}
...
%\begin{center}
%	\vspace{5pt}
%	\Vhrulefill{} \textbf{Preprints} {} \Vhrulefill
%	\vspace{4pt}
%\end{center}

\item[42\hspace{4pt}] \textbf{Spin-flip pair-density functional theory: A practical approach to treat static and dynamical correlations in large molecules} \\
Oinam Romesh Meitei, Nicholas J. Mayhall\\
Submitted, (2020)

\item[41\hspace{4pt}] \textbf{Gate-free state preparation for fast variational quantum eigensolver simulations: ctrl-VQE} \\
Oinam Romesh Meitei*, Bryan T. Gard*, George S. Barron, David P. Pappas, Sophia E. Economou, Edwin Barnes, Nicholas J. Mayhall\\
Submitted, (2020), *Co-first authors

\item[40\hspace{4pt}] \textbf{An adaptive quantum approximate optimization algorithm for solving combinatorial problems on a quantum computer} \\
...
%Submitted, (2019): \href{https://chemrxiv.org/articles/Simple_and_Efficient_Truncation_of_Virtual_Spaces_in_Embedded_Wave_Functions_via_Concentric_Localization/8846108/2}{ChemRxiv}
...
\section{\textbf{\color{red}Project Funding}}
\begin{lonelist}
\setlength\itemsep{.75pt}
\item[] 	\begin{tabular}{l|l}
		Total Amount & \$5,368,430 \\
		Total Budget for Mayhall lab& \$1,750,549\\
		Number of grants & 5
	\end{tabular} \\
\item 	{\bf CAREER: Many-body expansions for strongly correlated systems} \\
	\begin{tabular}{l|l}
		%Role on project& Sole PI \\
		PI	& Mayhall \\
		co-PIs	& -- \\
		Source of Support& National Science Foundation \\
		Total award amount& \$575,305 \\
		Total award period& Apr.1, 2018 - Mar. 31, 2023 \\
		Award Number& 1752612 \\
	\end{tabular} \\

\item
	{\bf Simulating strongly correlated molecules with a superconducting processor}\\
	\begin{tabular}{l|l}
		PI	& Mayhall \\
		co-PIs	& Sophia Economou, Edwin Barnes, David Pappas \\
		Source of Support& Department of Energy \\
		Total award amount& \$1,875,000 (Mayhall's budget \$308,871)  \\
		Total award period& Sept. 15, 2018 - Sep. 14, 2021 \\
		Award Number& 	DE-SC0019199
	\end{tabular} \\

\item
	{\bf Ab initio design of quantum molecular magnets for information applications} \\
	\begin{tabular}{l|l}
		PI	& Edwin Barnes \\
		co-PIs	& Mayhall, Sophia Economou, Kyunghwa Park \\
		Source of Support & Department of energy \\
		Total award amount& \$1,800,000 (Mayhall's budget \$610,526 ) \\
		Total award period& Sept.1, 2017 - Aug. 31, 2021 \\
		Award Number& DE-SC0018326 
	\end{tabular}\\
...
\section{\textbf{\color{red}Service}}
\begin{itemize}
	...
	\item Reviewer
		\begin{itemize}
			...
			\item[] Chemical Science
			\item[] Journal of Physical Chemistry Letters
			\item[] Molecular Physics
			\item[] Chemical Physics Letters
			\item[] Nature Communications
			\item[] Advanced Quantum Technologies
			\item[]	Quantum
		\end{itemize}
	\item Symposium Organization
		\begin{itemize}
			\setlength\itemsep{.0pt}
			\item[] {\it Exploring Transition Metal Chemistry \& Spectroscopy with Quantum Chemistry}, National ACS Meeting in San Diego (2019)
		\end{itemize}
\end{itemize}
...
\section{\textbf{\color{red}Students/Postdocs Mentored}}
\begin{lonelist}
	  \setlength\itemsep{.75pt}
	  \item[] Daniel Claudino (postdoc, currently at Oakridge National Lab)
	  \item[] Oinam Meitei (postdoc)
	  \item[] Luke Bertels (postdoc)
	  \item[] Shannon Houck (grad student)
	  \item[] Vibin Abraham (grad student)
	  \item[] Harper Grimsley (grad student)
	  \item[] Nicole Braunscheidel (grad student)
	  \item[] Robert Smith (undergrad student)
\end{lonelist}
\blankline

\section{\textbf{\color{red}Courses Taught}}
\begin{lonelist}
	  \setlength\itemsep{.75pt}
	  \item[] CHEM 6634: Quantum Chemistry and Spectroscopy 
	  \item[] CHEM 3616: Physical Chemistry
\end{lonelist}
...
\section{\textbf{\color{red}Presentations}}
\begin{lonelist}

\item[$\bullet$] \textbf{Invited Talk:} \textit{Selected Configuration Interaction in a Basis of Cluster State Tensor Products}\\
TPMSCM21, Dresden, Germany, March 10 (2021) 

\item[$\bullet$] \textbf{Invited Talk:} \textit{Outrunning decoherence: Fast state preparation for studying molecules with quantum computers}\\
University of South Dakota, Chemistry Seminar, Nov. 9 (2020) 

\item[$\bullet$] \textbf{Invited Talk:} \textit{Outrunning decoherence: Fast state preparation to increase the accuracy of near-term variational quantum computing}\\
Ohio State University, Physical Chemistry Seminar, Oct. 5 (2020) 

\item[$\bullet$] \textbf{Invited Talk:} \textit{Quasi-optimally compact ansatze for quantum chemistry VQE simulations}\\
Psi-k 2020, EPFL, Lausanne, Switzerland, Sept 14-17 (2020) (Cancelled for COV-19)

\item[$\bullet$] \textbf{Invited Talk:} \textit{Using quantum computers to solve quantum chemistry problems}\\
Virginia Tech, Highlands Chemistry Colloquium, Sept. 4 (2020) 

\item[$\bullet$] \textbf{Invited Talk:} \textit{Quasi-optimally compact ansatze for quantum chemistry VQE simulations}\\
Canadian Chemistry Conference and Exhibition, Winnepeg, Canada, May 24-28 (2020) (Cancelled for COV-19)

\item[$\bullet$] \textbf{Invited Talk:} \textit{Tensor product methods for strongly correlated molecular systems}\\
TPMSCM, Dresden, Germany, March 9 (2020) (Cancelled for COV-19)

\item[$\bullet$] \textbf{Invited Talk:} \textit{Tensor product states for more compact electronic state descriptions}\\
Sanibel Symposium, February 16 (2020)
...
\section{\textbf{\color{red}Student/Postdoc Talks}}
\begin{lonelist}
\item[$\bullet$] (Invited) Meitei*, Mayhall, {\it Gate-free state preparation for fast variational quantum eigensolver simulations }, MIT, Van Voorhis Group, Oct. 29 (2020)
\item[$\bullet$] Oinam Meitei; Gate-free state preparation for fast variational quantum eigensolver simulations: ctrl-VQE; Quantum computing for quantum chemistry; Cambridge Quantum Computing, 25th Sept. 2020
\item[$\bullet$] Vibin Abraham; Tensor Product Selected CI: Compact wave function for strongly correlated clusterable systems; Virtual Conference on Theoretical Chemistry June 27-29 2020
\item[$\bullet$] Oinam Meitei; Optimal control in variational quantum simulation for molecules; Virtual Conference on Theoretical Chemistry 2020, 29th July 2020
\item[$\bullet$] Claudino*, Mayhall, {\it Compact and optimal representation of embedded wave functions via concentric localization}, Sanibel Symposium, St. George, GA, Feb. 16-21 (2020)
\item[$\bullet$] (Invited) Shannon Houck*, {\it Combining spin-flip and IP/EA approaches for handling spin and spatial degeneracies: Application to double exchange systems}, 255th ACS Meeting Orlando, FL (2019)
\item[$\bullet$] Daniel Claudino*, {\it Automatic partition of orbital spaces based on singular value decomposition in the context of embedding}, 255th ACS Meeting Orlando, FL (2019)
\end{lonelist}
